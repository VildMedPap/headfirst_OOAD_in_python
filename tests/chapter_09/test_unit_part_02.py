import pytest
from ooad.chapter_09.take_02.units.unit import Unit
from ooad.chapter_09.take_02.units.weapon import Weapon
...
class TestUnit:
    ...
    def test_getting_a_unit_specific_property_when_non_exists(self):
        # Given
        # Existing Unit object
        unit = Unit(id=42)
        ...
        # Then
        # It should raise a AttributeError
        with pytest.raises(AttributeError):
            unit.get_property(property="strengt")
